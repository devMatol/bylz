          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-brand-primary/10 border border-brand-primary/20 text-brand-primary text-xs font-bold tracking-wide">
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                  <Link
                    to="/essai"
                    className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 text-base font-bold text-white bg-gradient-to-r from-brand-primary to-brand-primary/90 hover:from-brand-primary/90 hover:to-brand-primary px-8 py-4 rounded-full shadow-xl shadow-brand-primary/30 hover:shadow-brand-primary/50 transition-all duration-300 hover:-translate-y-1"
                  >
                ...
                {/* Inline Trust Badges */}
                <div className="pt-4 flex flex-wrap items-center justify-center lg:justify-start gap-4 text-xs font-medium text-muted">
                  <span className="flex items-center text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-500/10 px-2.5 py-1 rounded-full border border-emerald-500/20">
                    ✓ Agréé DGFiP 2026
                  </span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-6 space-y-6">
                ...
                <ul className="space-y-3 text-sm font-medium text-text">
              ...
              <div className="lg:col-span-6">
                <div className="bg-surface border border-border rounded-2xl p-6 shadow-xl card-shadow">
                  <div className="flex items-center justify-between border-b border-border pb-3 mb-4">
                    ...
                    <span className="text-xs font-mono text-brand-primary">Prêt à émettre</span>
                  </div>
                  <div className="space-y-3 text-xs">
                    <div className="p-3 rounded-xl bg-surface-hover/60 border border-border flex items-center justify-between">
                      <div>
                        <p className="font-semibold text-text">Client B2B sélectionné</p>
                        <p className="text-muted text-[11px]">Acme Studio SAS — SIRET 892 019 203</p>
                      </div>
                      <span className="text-emerald-500 text-[11px] font-bold">✓ Validé</span>
                    </div>
                    <div className="p-3 rounded-xl bg-surface-hover/60 border border-border space-y-2">
                      <div className="flex justify-between font-semibold text-text">
                        <span>Prestation Conseil & Dev</span>
                        <span>1 200,00 €</span>
                      </div>
                      <p className="text-[11px] text-muted">Mention légale : Franchise de TVA art. 293 B du CGI</p>
                    </div>
                    <div className="p-3 rounded-xl bg-brand-primary/10 border border-brand-primary/20 flex items-center justify-between font-bold text-brand-primary">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 order-2 lg:order-1">
                <div className="bg-surface border border-border rounded-2xl p-6 shadow-xl card-shadow space-y-4">
                  <div className="flex items-center justify-between border-b border-border pb-3">
                    <span className="text-xs font-bold text-text uppercase tracking-wider">Santé Fiscale & Cotisations</span>
                    <span className="text-xs font-semibold text-emerald-500">Année en cours</span>
                  </div>
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    <div className="p-3 rounded-xl bg-surface-hover/60 border border-border">
                      <p className="text-muted text-[11px]">Chiffre d'Affaires</p>
                      <p className="text-base font-bold text-text font-mono">28 450,00 €</p>
                    </div>
                    <div className="p-3 rounded-xl bg-surface-hover/60 border border-border">
                      <p className="text-muted text-[11px]">URSSAF estimé</p>
                  ...
                  <div className="p-3.5 rounded-xl bg-amber-500/5 border border-amber-500/20 space-y-2 text-xs">
                    <div className="flex justify-between font-semibold">
                      ...
                      <span className="font-mono text-amber-600">72%</span>
                    </div>
                    <div className="w-full bg-border rounded-full h-2 overflow-hidden">
                      <div className="bg-amber-500 h-2 rounded-full w-[72%]" />
                    </div>
                    <p className="text-[11px] text-muted">Il vous reste 10 650 € avant le passage à la TVA.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              ...
              <div className="bg-surface border border-border rounded-2xl p-8 space-y-6 shadow-sm">
                <div>
                  ...
                  <p className="text-xs text-muted mt-1">Pour démarrer en toute sérénité</p>
              ...
              <div className="bg-surface border border-border rounded-2xl p-8 space-y-6 shadow-sm">
                <div>
                  ...
                  <p className="text-xs text-muted mt-1">Pour maximiser votre activité</p>
                  <div className="mt-4 flex items-baseline space-x-1">
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full text-left p-5 flex items-center justify-between gap-4 font-bold text-text text-sm sm:text-base hover:bg-surface-hover/50 transition-colors"
                    >
                      <span>{faq.q}</span>
                      <ChevronDown
                    ...
                    {isOpen && (
                      <div className="p-5 pt-0 text-xs sm:text-sm text-muted leading-relaxed border-t border-border/50">
                        {faq.a}
                      </div>
                    )}
                  </div>
        ...
        <section className="py-20 bg-gradient-to-r from-brand-primary via-indigo-600 to-brand-accent text-white text-center relative overflow-hidden">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
            ...
            <div className="pt-4">
              <Link
                to="/essai"
                className="inline-flex items-center space-x-3 text-base font-bold text-brand-primary bg-white hover:bg-slate-100 px-8 py-4 rounded-full shadow-2xl hover:scale-105 transition-all duration-300"
              >
                <span>Démarrer l'essai gratuit</span>
                <ArrowRight className="w-5 h-5 text-brand-primary" />
              </Link>
            </div>
            <p className="text-xs text-white/70">Sans engagement — Résiliable à tout moment</p>
          </div>
        </section>
      </main>
