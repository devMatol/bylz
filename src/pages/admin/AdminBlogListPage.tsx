        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2 flex-1">
            <h3 className="text-sm font-extrabold text-rose-200">
              La table <code className="font-mono bg-rose-900/50 px-1.5 py-0.5 rounded">public.blog_posts</code> nécessite une création sur Supabase pour la sauvegarde en base.
            </h3>
            <p className="text-xs text-rose-300/80 leading-relaxed">
              Pour enregistrer vos articles générés par IA dans la base de données, copiez et exécutez le script ci-dessous dans votre <strong>Supabase SQL Editor</strong> (<em>dashboard.supabase.com &gt; SQL Editor</em>) :
            </p>
            ...
            <div className="relative bg-slate-950 p-3 rounded-lg border border-slate-800 font-mono text-[11px] text-slate-300 overflow-x-auto">
              <pre>{`CREATE TABLE IF NOT EXISTS blog_posts (
...
CREATE POLICY "Public view published" ON blog_posts FOR SELECT USING (status = 'published');
CREATE POLICY "Admins manage blog_posts" ON blog_posts FOR ALL USING (true);`}</pre>
            </div>
            ...
            <div className="pt-2 flex items-center gap-3">
              <Button
                ...
                size="sm"
                onClick={() => {
                  navigator.clipboard.writeText(`CREATE TABLE IF NOT EXISTS blog_posts (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  slug text UNIQUE NOT NULL,
  title text NOT NULL,
  excerpt text NOT NULL,
